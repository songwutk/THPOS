...
class Sales extends Secure_area
{
	...
	function complete()
	{
		...
		$data['sale_id']='BL'.$this->Sale->save($data['cart'], $customer_id,$employee_id,$comment,$data['payments']);
		if ($data['sale_id'] == 'BL-1')
		{
	...
	function suspend()
	{
		...
		//SAVE sale to database
		$data['sale_id']='BL'.$this->Sale_suspended->save($data['cart'], $customer_id,$employee_id,$comment,$data['payments']);
		if ($data['sale_id'] == 'BL-1')
		{
			$data['error_message'] = $this->lang->line('sales_transaction_failed');
		}
